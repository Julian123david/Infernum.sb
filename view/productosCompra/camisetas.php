...
<div class="contenedor_general">
	<?php
	/*VaidrollTeam*/
	$productos_array = $usar_db->vaiquery("SELECT p.id , C.idCategoria, p.img, p.cod, p.nom, p.pre, p.EstadoProducto FROM Producto p  inner join Categoria c  on p.idCategoria = c.idCategoria WHERE EstadoProducto = 'Disponible' and c.IdCategoria= 1 ORDER BY id ASC;
	");
